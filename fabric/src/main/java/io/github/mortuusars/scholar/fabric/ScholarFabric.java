...
public class ScholarFabric implements ModInitializer {
    ...
    public void onInitialize() {
        ModLoadingContext.registerConfig(Scholar.ID, ModConfig.Type.COMMON, Config.Common.SPEC);
        ModLoadingContext.registerConfig(Scholar.ID, ModConfig.Type.CLIENT, Config.Client.SPEC);
